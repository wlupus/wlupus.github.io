---
title: "Git proxy settings on Windows"
date: 2022-04-19T01:01:02+08:00
draft: false
description: "Git proxy settings on Windows platform"
...
{{<admonition failure>}}
This page hasn't been translated yet. You are welcomed to translate this page and add a pull request to [the repo](https://github.com/wlupus/wlupus.github.io)
{{</admonition>}}
# 1. http/https 代理
查看代理
```bash
